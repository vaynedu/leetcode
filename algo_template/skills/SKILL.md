...
| 回溯/DFS | 缺失 17,22,39,40,46,47,78,90 | 部分 |
| 动态规划 | 缺失 53,62,63,64,70,96,120 | ✅ 模板 |
| 堆/优先队列 | 23,239 已有，缺失 215,295,373 | ❌ |
| Trie | 缺失 208,211,212,648 | ❌ |
...
| 回溯/DFS | ✅ 完整 | 8题(未创建) | 待补：17/22/39/40/46/47/78/90 |
| 动态规划 | ✅ 完整 | 7题(未创建) | 待补：53/62/63/64/70/96/120 |
| 堆/优先队列 | ⚠️ 部分 | 3题(23,215,146) | 待补：295,373，模板未建 |
| 栈 | ✅ 完整 | 1题(32) | 待补：更多 |
